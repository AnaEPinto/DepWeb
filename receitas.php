            ...
            <div class="flex-1 md:px-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-[#FFFFFF] rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-100 group">
                        <div class="relative">
                            <img class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" src="imagem/<?= $imagem ?>" alt="Receita <?= $idReceita ?>">
                            <button class="absolute top-3 right-3 bg-[#FFFFFF]/90 p-2 rounded-full text-gray-400 hover:text-red-500 hover:bg-[#FFFFFF] transition-colors shadow-sm">
